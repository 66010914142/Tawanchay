...
<div class="container py-5">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white">
            <h1 class="h4 card-title mb-0">ฟอร์มสมัครสมาชิก -- ตะวันฉาย สวัสดิ์พาณิชย์(ซัน) -- Gemini</h1>
        </div>
        <div class="card-body">
    ...
    if(isset($_POST['Submit'])){
        ...
        $major = $_POST['major'];
    ?>
        <div class="alert alert-success mt-4 shadow" role="alert">
            <h4 class="alert-heading"><i class="bi bi-info-circle-fill me-2"></i>ข้อมูลการสมัครสมาชิกถูกส่งแล้ว</h4>
            <hr>
            <p class="mb-1"><strong>ชื่อ-นามสกุล:</strong> <?php echo $fullname; ?></p>
            <p class="mb-1"><strong>เบอร์โทร:</strong> <?php echo $phone; ?></p>
            <p class="mb-1"><strong>ความสูง:</strong> <?php echo $height; ?> ซม.</p>
            <p class="mb-1 d-flex align-items-center">
                <strong>สีที่ชอบ:</strong> <?php echo $color; ?> 
                &nbsp; 
                <span class="d-inline-block rounded-circle" style="width: 20px; height: 20px; background-color: <?php echo $color; ?>; border: 1px solid #000;"></span>
            </p>
            <p class="mb-0"><strong>สาขาวิชา:</strong> <?php echo $major; ?></p>
        </div>
    <?php
    }
    ?>
