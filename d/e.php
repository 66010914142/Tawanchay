...
<div class="container py-5">
    ...
    <div class="mt-4">
        ...
        if(isset($_POST['submit'])){
            ...
            // แสดงผลลัพธ์ใน Alert สีฟ้า/เขียวอ่อน
            echo '<div class="alert alert-info mt-4 shadow" role="alert">';
            echo '<h4 class="alert-heading"><i class="bi bi-check-circle-fill me-2"></i>ใบสมัครของคุณถูกส่งแล้ว!</h4>';
            echo '<hr>';
            ...
            echo '<p><strong>ทักษะเด่น:</strong><br>' . (empty($skills) ? '-' : $skills) . '</p>';
            echo '<p class="mb-0"><strong>ประสบการณ์:</strong><br>' . (empty($experience) ? '-' : $experience) . '</p>';
            echo '</div>';
        }
        ?>
    </div>
